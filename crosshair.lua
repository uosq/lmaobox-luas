...
register("Draw", function()
    ...
    do
        alib.objects.sliderfade(R_slider.width, R_slider.height, R_slider.x + window.x, R_slider.y + window.y,
            R_slider.min, R_slider.max, R_slider.value, 255, 50, true)
        ...
        draw.Text(R_slider.x + window.x + math.floor(R_slider.width * percent) - tw,
            R_slider.y + math.floor(th / 2) + window.y, tostring(R_slider.value))
    end

    do
        alib.objects.sliderfade(G_slider.width, G_slider.height, G_slider.x + window.x, G_slider.y + window.y,
            G_slider.min, G_slider.max, G_slider.value, 255, 50, true)
        ...
        draw.Text(G_slider.x + window.x + math.floor(G_slider.width * percent) - tw,
            G_slider.y + math.floor(th / 2) + window.y, tostring(G_slider.value))
    end

    do
        alib.objects.sliderfade(B_slider.width, B_slider.height, B_slider.x + window.x, B_slider.y + window.y,
            B_slider.min, B_slider.max, B_slider.value, 255, 50, true)
        ...
        draw.Text(B_slider.x + window.x + math.floor(B_slider.width * percent) - tw,
            B_slider.y + math.floor(th / 2) + window.y, tostring(B_slider.value))
    end

    do
        alib.objects.sliderfade(A_slider.width, A_slider.height, A_slider.x + window.x, A_slider.y + window.y,
            A_slider.min, A_slider.max, A_slider.value, 255, 50, true)
        ...
        draw.Text(A_slider.x + window.x + math.floor(A_slider.width * percent) - tw,
            A_slider.y + math.floor(th / 2) + window.y, tostring(A_slider.value))
    end

    do
        alib.objects.sliderfade(size_slider.width, size_slider.height, size_slider.x + window.x, size_slider.y + window
        .y, size_slider.min, size_slider.max, size_slider.value, 255, 50, true)
        ...
        draw.Color(255, 255, 255, 255)
        draw.Text(size_slider.x + window.x + math.floor(size_slider.width * percent) - tw,
            size_slider.y + math.floor(th / 2) + window.y, tostring(size_slider.value))
    end
end)
