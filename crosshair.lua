...
local function draw_crosshair (x, y)
    line(x, y - math.floor(size_slider.value/2) - 10, x, y + math.floor(size_slider.value/2) - 10) -- top
    line(x - math.floor(size_slider.value/2) - 10, y, x + math.floor(size_slider.value/2) - 10, y) -- left
    line(x + math.floor(size_slider.value/2) + 10, y, x - math.floor(size_slider.value/2) + 10, y) -- right
    line(x, y + math.floor(size_slider.value/2) + 10, x, y - math.floor(size_slider.value/2) + 10) -- top
end
...
register("Draw", function()
    ...
    do
        ...
        draw.Color(A_slider.value, A_slider.value, A_slider.value, A_slider.value)
